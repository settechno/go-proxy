...
### Состав сервера:
**./server** - само приложение сервера

**./create-user** - скрипт добавления пользователей

**config.json** - настройки сервера. Формат:
```json
{
  "port": 1080,               // порт
  "use_auth": true,           // требовать авторизацию
  "user_file": "users.json",  // расположение файла с пользователями
  "user_reload_duration": 1   // Время автообновления списка пользователей в минутах
}
```
